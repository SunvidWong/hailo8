...
def demo_quick_integration():
    ...
    try:
        ...
        print("SUCCESS: Quick integration completed!")
        print("Project created at: " + project_path)
        print("Integration files: " + project_path + "/hailo8/")
        
        return True
        
    except Exception as e:
        print("FAILED: Quick integration failed: " + str(e))
        return False
...
def demo_detailed_integration():
    ...
    try:
        ...
        print("SUCCESS: Detailed integration completed!")
        print("Project created at: " + project_path)
        ...
        print("FAILED: Detailed integration failed: " + str(e))
        return False
...
def demo_project_integration():
    ...
    try:
        ...
        print("SUCCESS: Project integration completed!")
        print("Enhanced project at: " + project_path)
        ...
        print("FAILED: Project integration failed: " + str(e))
        return False
...
def create_complex_project(project_path):
    ...
    # Create API server
    with open(project_path + "/src/api/server.py", "w") as f:
        f.write("""#!/usr/bin/env python3
...
""")
    ...
    with open(project_path + "/src/models/handler.py", "w") as f:
        f.write("""#!/usr/bin/env python3
class ModelHandler:
    def __init__(self):
        self.models = {}
...
def run_all_demos():
    ...
    for name, demo_func in demos:
        try:
            ...
            print("FAILED: " + name + " demo failed with exception: " + str(e))
    ...
    print("\nTotal: " + str(success_count) + "/" + str(len(results)) + " demos successful")
